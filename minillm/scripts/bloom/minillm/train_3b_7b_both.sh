...
CKPT_NAME="bloom-3b"
CKPT="/dtu/p1/johlau/LMOps/minillm/results/bloom/train/minillm_both/bs2-lr5e-06-G2-N1-NN1-lm1-len256/pe4_rs0.5_nr32_ln_sr_tm0.2/3000"
TEACHER_CKPT_NAME="bloom-7b1"
TEACHER_CKPT="bigscience/bloom-7b1"
MP_SIZE=4
# data
PROMPT_DATA_DIR="${BASE_PATH}/processed_data/dolly_both/prompt/bloom/"
LM_DATA_DIR="${BASE_PATH}/processed_data/roberta_both/bloom/256/20M/"
# runtime
SAVE_PATH="${BASE_PATH}/results/bloom/train/minillm_both/"
# hp
GRAD_ACC=2
BATCH_SIZE=2
CHUNK_SIZE=2
