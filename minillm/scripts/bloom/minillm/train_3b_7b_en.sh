...
CKPT_NAME="bloom-3b"
CKPT="bigscience/bloom-3b"
TEACHER_CKPT_NAME="bloom-7b1"
TEACHER_CKPT="bigscience/bloom-7b1"
MP_SIZE=4
# data
PROMPT_DATA_DIR="${BASE_PATH}/processed_data/dolly_en/prompt/bloom/"
LM_DATA_DIR="${BASE_PATH}/processed_data/roberta_en/bloom/256/20M/"
# runtime
SAVE_PATH="${BASE_PATH}/results/bloom/train/minillm_en/"
# hp
GRAD_ACC=2
BATCH_SIZE=2
CHUNK_SIZE=2
