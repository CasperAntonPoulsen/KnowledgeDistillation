...
MP_SIZE=4
# data
PROMPT_DATA_DIR="${BASE_PATH}/processed_data/dolly_both/prompt/llama/"
LM_DATA_DIR="${BASE_PATH}/processed_data/roberta_both/llama/256/20M/"
# runtime
SAVE_PATH="${BASE_PATH}/results/llama/train/minillm_both/"
# hp
GRAD_ACC=2
BATCH_SIZE=2
CHUNK_SIZE=2
