...
if __name__ == "__main__":
    ...
    tokenizer = AutoTokenizer.from_pretrained("/dtu/p1/johlau/LMOps/minillm/results/llama/train/sft/llama-13B")
    model = AutoModelForCausalLM.from_pretrained("/dtu/p1/johlau/LMOps/minillm/results/llama/train/sft/llama-13B")
