...
if __name__ == "__main__":
    ...
    tokenizer = AutoTokenizer.from_pretrained("/dtu/p1/johlau/distilled_models/llama_spanish_1000it")
    model = AutoModelForCausalLM.from_pretrained("/dtu/p1/johlau/distilled_models/llama_spanish_1000it")
