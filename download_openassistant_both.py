...
with open("/dtu/p1/johlau/LMOps/minillm/data/dolly_both/raw.jsonl", "w+") as file:
    df_combined[df_combined["lang"].isin(["en", "es"])].to_json(file, orient="records", lines=True)